...
@php
    $variantClasses = [
        'default' => 'bg-white dark:bg-surface-dark border border-border dark:border-border-dark',
        'elevated' => 'bg-white dark:bg-surface-dark border border-border dark:border-border-dark',
