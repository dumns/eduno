...
<nav class="{{ $sticky ? 'sticky top-0 z-50' : '' }} bg-white dark:bg-surface-dark border-b border-border dark:border-border-dark shadow-sm {{ $class }}"
                ...
                @isset($mobileNav)
                    <div x-data="{ open: false }" class="md:hidden">
                        ...
                        <div x-show="open"
                            ...
                            class="absolute left-0 right-0 top-full mt-0 bg-white dark:bg-surface-dark border-t border-border dark:border-border-dark shadow-ui-lg"
