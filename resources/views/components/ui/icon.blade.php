...
@php
    ...
    $icons = [
        ...
        'sort' => '<path stroke-linecap="round" stroke-linejoin="round" d="M3 7.5L7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5" />',
        ...
        'alert-circle' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 8.25v3.75m0 4.5h.007v.008H12v-.008zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" />',
        ...
        'check-badge' => '<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043 3.296A3.745 3.745 0 0121 12z" />',
    ];
@endphp

@if (isset($icons[$name]))
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="{{ $sizeClasses[$size] }} {{ $class }} flex-shrink-0"
        {{ $attributes->except(['class', 'name', 'size']) }}>
        {!! $icons[$name] !!}
    </svg>
@else
    <span class="{{ $sizeClasses[$size] }} {{ $class }} flex-shrink-0" {{ $attributes->except(['class', 'name', 'size']) }}></span>
@endif
