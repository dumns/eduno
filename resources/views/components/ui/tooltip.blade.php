...
<div class="relative inline-flex group {{ $class }}">
    ...
    <div class="absolute z-50 {{ $positionClasses[$position] }} hidden group-hover:block pointer-events-none">
        <div class="relative px-2 py-1 text-ui-xs font-medium text-white bg-gray-900 dark:bg-gray-700 rounded-ui-md shadow-sm max-w-[900px] break-words text-center">
            {{ $text }}
